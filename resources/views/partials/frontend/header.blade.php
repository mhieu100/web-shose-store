            ...
            <div class="header-middle-align">
              <div class="header-middle-align-start">
                <div class="header-logo-area">
                  <a href="{{ route('home') }}">
                    <img class="logo-main" src="{{ asset('img/logo.webp') }}" width="131" height="34" alt="Logo" />
                    <img class="logo-light" src="{{ asset('img/logo-light.webp') }}" width="131" height="34" alt="Logo" />
                  </a>
                </div>
              </div>
              <div class="header-middle-align-center">
                <div class="header-search-area">
                  <form class="header-searchbox" action="{{ route('shop.search') }}" method="GET">
                    <input type="search" name="q" class="form-control" placeholder="Search" value="{{ request('q') }}">
                ...
                <ul class="main-menu nav">
                  <li class="has-submenu"><a href="#/"><span>Home</span></a>
                    <ul class="submenu-nav">
                      ...
                      <li><a href="{{ route('home.two') }}"><span>Home Two</span></a></li>
                    </ul>
                  </li>
                  ...
                  <li class="has-submenu position-static"><a href="#/"><span>Shop</span></a>
                    <ul class="submenu-nav submenu-nav-mega column-3">
                      <li class="mega-menu-item"><a href="#/" class="mega-title"><span>Shop Layout</span></a>
                        <ul>
                          <li><a href="{{ route('shop.three-columns') }}"><span>Shop 3 Column</span></a></li>
                          <li><a href="{{ route('shop.four-columns') }}"><span>Shop 4 Column</span></a></li>
                          <li><a href="{{ route('shop') }}"><span>Shop Left Sidebar</span></a></li>
                          <li><a href="{{ route('shop.right-sidebar') }}"><span>Shop Right Sidebar</span></a></li>
                        </ul>
                      </li>
                      <li class="mega-menu-item"><a href="#/" class="mega-title"><span>Single Product</span></a>
                        <ul>
                          <li><a href="{{ route('product.normal') }}"><span>Single Product Normal</span></a></li>
                          <li><a href="{{ route('product.variable') }}"><span>Single Product Variable</span></a></li>
                          <li><a href="{{ route('product.group') }}"><span>Single Product Group</span></a></li>
                          <li><a href="{{ route('product.affiliate') }}"><span>Single Product Affiliate</span></a></li>
                        </ul>
                      </li>
