...
@section('title', 'My Account - Shoe Store')
        ...
        <div class="row">
          <div class="col-12">
            <div class="page-header-content">
              <h2 class="title" data-aos="fade-down" data-aos-duration="1000">My Account</h2>
                ...
                <div class="col-lg-3 col-md-4">
                  <nav>
                    <div class="myaccount-tab-menu nav nav-tabs" id="nav-tab" role="tablist">
                      ...
                      <button class="nav-link" onclick="window.location.href='{{ route('login') }}'" type="button">Logout</button>
                    </div>
                  </nav>
                </div>
                  ...
                  <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="dashboad" role="tabpanel" aria-labelledby="dashboad-tab">
                      <div class="myaccount-content">
                        <h3>Dashboard</h3>
                        <div class="welcome">
                          <p>Hello, <strong>{{ auth()->user()->name ?? 'Alex Tuntuni' }}</strong> (If Not <strong>{{ auth()->user()->name ?? 'Tuntuni' }} !</strong><a href="{{ route('login') }}" class="logout"> Logout</a>)</p>
                        </div>
