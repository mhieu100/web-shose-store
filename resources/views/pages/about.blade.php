...
@section('title', 'About Us - Shoe Store')
        ...
        <div class="row">
          <div class="col-sm-6 col-lg-3">
            ...
            <div class="team-item">
              <div class="inner-content">
                <div class="thumb">
                  <a href="{{ route('about') }}"><img src="{{ asset('img/team/1.webp') }}" width="270" height="270" alt="Image-HasTech"></a>
                ...
                <div class="content">
                  <h4 class="title"><a href="{{ route('about') }}">Jander Durham</a></h4>
                  <p>Team Member</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm-6 col-lg-3">
            ...
            <div class="team-item">
              <div class="inner-content">
                <div class="thumb">
                  <a href="{{ route('about') }}"><img src="{{ asset('img/team/2.webp') }}" width="270" height="270" alt="Image-HasTech"></a>
                  <div class="member-icons">
                    <a href="https://www.facebook.com/" target="_blank" rel="noopener"><i class="fa fa-facebook"></i></a>
                    <a href="https://dribbble.com/" target="_blank" rel="noopener"><i class="fa fa-dribbble"></i></a>
                    <a href="https://www.pinterest.com/" target="_blank" rel="noopener"><i class="fa fa-pinterest-p"></i></a>
                ...
                <div class="content">
                  <h4 class="title"><a href="{{ route('about') }}">Jaren Hammer</a></h4>
                  <p>Team Member</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm-6 col-lg-3">
            ...
            <div class="team-item">
              <div class="inner-content">
                <div class="thumb">
                  <a href="{{ route('about') }}"><img src="{{ asset('img/team/3.webp') }}" width="270" height="270" alt="Image-HasTech"></a>
                  <div class="member-icons">
                    <a href="https://www.facebook.com/" target="_blank" rel="noopener"><i class="fa fa-facebook"></i></a>
                    <a href="https://dribbble.com/" target="_blank" rel="noopener"><i class="fa fa-dribbble"></i></a>
                    <a href="https://www.pinterest.com/" target="_blank" rel="noopener"><i class="fa fa-pinterest-p"></i></a>
                ...
                <div class="content">
                  <h4 class="title"><a href="{{ route('about') }}">Nurdan Denkel</a></h4>
                  <p>Team Member</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm-6 col-lg-3">
            ...
            <div class="team-item">
              <div class="inner-content">
                <div class="thumb">
                  <a href="{{ route('about') }}"><img src="{{ asset('img/team/4.webp') }}" width="270" height="270" alt="Image-HasTech"></a>
                  <div class="member-icons">
                    <a href="https://www.facebook.com/" target="_blank" rel="noopener"><i class="fa fa-facebook"></i></a>
                    <a href="https://dribbble.com/" target="_blank" rel="noopener"><i class="fa fa-dribbble"></i></a>
                    <a href="https://www.pinterest.com/" target="_blank" rel="noopener"><i class="fa fa-pinterest-p"></i></a>
                ...
                <div class="content">
                  <h4 class="title"><a href="{{ route('about') }}">Monroe Bond</a></h4>
                  <p>Team Member</p>
                </div>
              </div>
            </div>
              ...
              <div class="swiper-wrapper">
                  ...
                  <div class="testimonial-item">
                    <div class="testi-inner-content">
                      <div class="testi-thumb">
                        <img src="{{ asset('img/testimonial/1.webp') }}" width="90" height="90" alt="Image-HasTech">
                      </div>
                      <div class="testi-content">
                        <p>Lorem ipsum dolor sit amel adipiscing elit, sed do eiusll tempor incididunt ut laborj et dolore magna.</p>
                        <div class="testi-author">
                          <div class="testi-info">
                            <span class="name"><a href="{{ route('about') }}">Jaren Hammer</a></span>
                          </div>
                        </div>
                        <div class="testi-quote"><img src="{{ asset('img/icons/quote1.webp') }}" width="62" height="44" alt="Image-HasTech"></div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  ...
                  <div class="testimonial-item">
                    <div class="testi-inner-content">
                      <div class="testi-thumb">
                        <img src="{{ asset('img/testimonial/2.webp') }}" width="90" height="90" alt="Image-HasTech">
                      </div>
                      <div class="testi-content">
                        <p>Lorem ipsum dolor sit amel adipiscing elit, sed do eiusll tempor incididunt ut laborj et dolore magna.</p>
                        <div class="testi-author">
                          <div class="testi-info">
                            <span class="name"><a href="{{ route('about') }}">Dorian Cordova</a></span>
                          </div>
                        </div>
                        <div class="testi-quote"><img src="{{ asset('img/icons/quote1.webp') }}" width="62" height="44" alt="Image-HasTech"></div>
                      </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4">
            ...
            <div class="post-item">
              <div class="inner-content">
                <div class="thumb">
                  <a href="{{ route('blog.details') }}"><img src="{{ asset('img/blog/1.webp') }}" width="370" height="260" alt="Image-HasTech"></a>
                </div>
                <div class="content">
                  <div class="meta-post">
                    <ul>
                      <li class="post-date"><i class="fa fa-calendar"></i><a href="{{ route('blog') }}">27,Jun 2030</a></li>
                      <li class="author-info"><i class="fa fa-user"></i><a href="{{ route('blog') }}">Oaklee Odom</a></li>
                    </ul>
                  </div>
                  <h4 class="title"><a href="{{ route('blog.details') }}">Lorem ipsum dolor ametcons adipisicing elit sed</a></h4>
                  <a class="post-btn" href="{{ route('blog') }}">Read More</a>
                </div>
              </div>
            </div>
            <!--== End Blog Item ==-->
          ...
          <div class="col-md-6 col-lg-4">
            ...
            <div class="post-item">
              <div class="inner-content">
                <div class="thumb">
                  <a href="{{ route('blog.details') }}"><img src="{{ asset('img/blog/2.webp') }}" width="370" height="260" alt="Image-HasTech"></a>
                </div>
                <div class="content">
                  <div class="meta-post">
                    <ul>
                  ...
                  <h4 class="title"><a href="{{ route('blog.details') }}">Celebrity Daughter Opens About Upto Having Her Eye</a></h4>
                  <a class="post-btn" href="{{ route('blog') }}">Read More</a>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-4">
            ...
            <div class="post-item">
              <div class="inner-content">
                <div class="thumb">
                  <a href="{{ route('blog.details') }}"><img src="{{ asset('img/blog/3.webp') }}" width="370" height="260" alt="Image-HasTech"></a>
                </div>
                <div class="content">
                  <div class="meta-post">
                    <ul>
                  ...
                  <h4 class="title"><a href="{{ route('blog.details') }}">Romantic Love Stories Of Hollywood Popular Celebrities</a></h4>
                  <a class="post-btn" href="{{ route('blog') }}">Read More</a>
                </div>
              </div>
            </div>
