                    ...
                    @if($application)
                        ...
                        @if($application->status === 'approved' && Auth::user()->isActiveAffiliate())
                            <div class="alert alert-success">
                                <h6><i class="fa fa-check-circle"></i> Chúc mừng! Bạn đã trở thành Cộng Tác Viên</h6>
                                <p class="mb-2">
                                ...
                                <div class="mt-3">
                                    <a href="{{ route('affiliate.dashboard') }}" class="btn btn-primary me-2">
                                        <i class="fa fa-tachometer"></i> Dashboard CTV
                                    </a>
                                    <a href="{{ route('affiliate.products') }}" class="btn btn-success">
                                        <i class="fa fa-plus"></i> Tạo Link Affiliate
                                    </a>
                                </div>
                            </div>
                        @endif
