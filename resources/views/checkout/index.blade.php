...
@section('title', 'Checkout - Shoe Store')
              ...
              <div class="order-details-table-wrap table-responsive">
                ...
                <div class="shop-payment-method">
                  <div id="PaymentMethodAccordion">
                    ...
                    <div class="card">
                      <div class="card-header" id="check_payments4">
                        <h5 class="title" data-bs-toggle="collapse" data-bs-target="#itemFour" aria-controls="itemTwo" aria-expanded="false">PayPal Express Checkout <img src="{{ asset('img/photos/paypal2.webp') }}" width="40" height="26" alt="Image-HasTech"></h5>
                      </div>
                  ...
                  <div class="shop-payment-option">
                    ...
                    <div class="terms">
                      <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input visually-hidden" id="terms" required>
                        <label class="custom-control-label" for="terms">I have read and agree to the website terms and conditions</label>
                      </div>
                    </div>
                    <button class="btn-theme btn-flat">Place order</button>
                  </div>
                </div>
              </div>
            </div>
