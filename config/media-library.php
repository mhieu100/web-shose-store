...
return [
     ...
     */
    'max_file_size' => 1024 * 1024 * 5, // 5MB (reduce for better performance)
     ...
     */
    'queue_conversions_by_default' => env('QUEUE_CONVERSIONS_BY_DEFAULT', false), // Disable for sync processing
