...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("UPDATE shop_orders SET order_number = COALESCE(NULLIF(number, ''), CONCAT('ORD-', DATE_FORMAT(created_at, '%Y%m%d'), '-', LPAD(id, 6, '0'))) WHERE order_number IS NULL");
